...
def get_train_dev_test_data(add_first_sentence = False):
    train_data = read_data(train_file, add_first_sentence)
    dev_data = read_data(dev_file, add_first_sentence)
    test_data = read_data(test_file, add_first_sentence)
